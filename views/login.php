            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4" id="tela_login">
                        <div class="row">
                            <div class=" col-md-12"><img src="<?php echo BASE_URL; ?>/assets/imagens/logo_login_siasif.jpg" alt="Logotipo da cootax" class="img-center img-login"></div>
                                ...
                                <form method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="iSerachUsuario" name="nSerachUsuario" class="form-control" autofocus placeholder="Usuario / E-mail">
                                        </div>                                    
                                    </div>
                                    <div class="form-group">
                ...
                <div class="row clear">
                    <div class="col-xs-12">
                        <br/>
                        <p class="text-center " style="color: #666">&copy; Copyright 2019 - <a href="http://lattes.cnpq.br/0856780614635850" target="_blank" style="color: #666">Joab Torres Alencar</a></p>
                    </div>
                </div>
            </div>
            <!--  MODEL -->
                ...
                <section class="modal-dialog modal-lg" role="document">
                    <article class="modal-content">
                        ...
                        <section class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <p class="text-justify">Forneça o endereço de email usado em sua conta do SIASIF.</p>
