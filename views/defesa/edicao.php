    ...
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-pencil-alt"></i> Ata de Defesa</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
    <div class="row">
        ...
        <div class="col-md-12 clear">
            <form enctype="multipart/form-data" autocomplete="off" method="POST">
                ...
                <input type="hidden" name="nCodServido" value="<?php echo!empty($defesa['servidor_cod']) ? $defesa['servidor_cod'] : !empty($servidor['cod']) ? $servidor['cod'] : ''; ?>"/>
                <input type="hidden" name="nCod" value="<?php echo!empty($defesa['cod']) ? $defesa['cod'] : 0; ?>"/>
                <section class="panel panel-black">
                    ...
                    <article class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group <?php echo (isset($defesa_error['data']['class'])) ? $defesa_error['data']['class'] : ''; ?>">
                                <label for='iData' class="control-label">Data *: <?php echo (isset($defesa_error['data']['msg'])) ? '<small><span class="glyphicon glyphicon-remove"></span> ' . $defesa_error['data']['msg'] . ' </small>' : ''; ?></label>
                                <input type="text" id="iData" name="nData" class="form-control input-data" placeholder="Exemplo: 01/01/2019" value="<?php echo (!empty($defesa['data'])) ? $this->formatDateView($defesa['data']) : ''; ?>"/>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <select class="form-control" name="nStatus" id="iStatus">
                                    ...
                                    foreach ($array as $indice) {
                                        if (isset($defesa['status']) && $indice['cod'] == $defesa['status']) {
                            ...
                            <div class="col-md-7 form-group <?php echo (isset($defesa_error['anexo']['class'])) ? $defesa_error['anexo']['class'] : ''; ?>">
                                <label class="control-label">Anexo (PDF): <span id="nome_arquivo" class="text-danger"><?php echo (isset($defesa_error['anexo']['msg'])) ? '<small><span class="glyphicon glyphicon-remove"></span> ' . $defesa_error['anexo']['msg'] . ' </small>' : ''; ?><?php echo isset($defesa['anexo']) ? $defesa['anexo'] : null; ?></span></label><br/>
                                ...
                                <input type="hidden" name="nFileEnviado"  value="<?php echo isset($defesa['anexo']) ? $defesa['anexo'] : null; ?>"/>
                            </div>
                        </div>
                    </article>
                </section>
