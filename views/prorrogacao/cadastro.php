                    ...
                    <article class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group <?php echo (isset($prorrogacao_error['inicio']['class'])) ? $prorrogacao_error['inicio']['class'] : ''; ?>">
                                ...
                                <input type="text" id="iInicio" name="nInicio" class="form-control input-data" placeholder="Exemplo: 01/01/2019" value="<?php echo (!empty($prorrogacao['inicio'])) ? $prorrogacao['inicio'] : ''; ?>"/>
                            </div>
                            <div class="col-md-3 form-group <?php echo (isset($prorrogacao_error['termino']['class'])) ? $prorrogacao_error['termino']['class'] : ''; ?>">
                                ...
                                <input type="text" id="iTermino" name="nTermino" class="form-control input-data" placeholder="Exemplo: 31/12/2020" value="<?php echo (!empty($prorrogacao['termino'])) ? $prorrogacao['termino'] : ''; ?>"/>
                            </div>
                        </div>
                    </article>
                </section>
