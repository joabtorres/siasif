    ...
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-user-alt"></i> Editar Servidor</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
    <div class="row">
        ...
        <div class="col-md-12 clear">
            <form method="POST" enctype="multipart/form-data" autocomplete="off" id="form_servidor">
                <input type="hidden" name="nCod" value="<?php echo!empty($servidor['cod']) ? $servidor['cod'] : 0; ?>"/>
                <section class="panel panel-black">
					...
					?>
                                ...
                                <div class="col-md-5 form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="nUnidade"  id="iUnidade">
					<?php
