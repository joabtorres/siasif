    ...
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-pencil-alt"></i> Relatório de Afastamento</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
                    ...
                    <article class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group <?php echo (isset($relatorio_error['data']['class'])) ? $relatorio_error['data']['class'] : ''; ?>">
                                ...
                                <input type="text" id="iData" name="nData" class="form-control input-data" placeholder="Exemplo: 01/01/2019" value="<?php echo (!empty($relatorio['data'])) ? $this->formatDateView($relatorio['data']) : ''; ?>"/>
                            </div>
                            <div class="col-md-2 form-group">
